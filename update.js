...
function update_value() {
  ...
  var passgv = $("#passgv_prof").val().replace(/ /g, '');

  var url = script_url + "?callback=ctrlq&passgv=" + passgv + "&idgv=" + idgv + "&action=update";
...
function showhidepass(){
  ...
  var temp_repeat = document.getElementById("passgv_prof");
